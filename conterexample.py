...
def create_mean_code_dict(model, generator, feeder):
    ...
    code_ = generate_code_dict_from_feeder(model, generator, feeder)
...
def generate_code_dict_from_feeder(model, generator, feeder, iterations = 500, save = None):
...
- cvae_cnn2: conditional vae with 2 cnn\n- cvae_cnn2: conditional vae with 3 cnn """)
    ...
    generate_code_dict_from_feeder(model, generator, feeder, iterations = 500, save = ("./data/code_dict_%s.pt" % timestamp, 'wb'))
